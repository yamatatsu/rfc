...
- JWE Encrypted
  ...
  - Key Encrypted Content Encryption Key value. Note that for some algorithms, the JWE Encrypted Key value is specified as being the empty octet sequence.
...
- JWE Authentication
  ...
  - Tag Authentication Tag value resulting from authenticated encryption of the plaintext with Additional Authenticated Data.
...
[nist.800-38d]: http://csrc.nist.gov/publications/nistpubs/800-38D/SP-800-38D.pdf
